...
object EmbedGenerator {
    ...
    fun nodeInfo(node: Node, utilizations: List<Utilization>): EmbedBuilder {
        return EmbedBuilder().apply {
            ...
            field("Memory Usage", true) { "${"%.2f".format(utilizations.sumOf { it.memory } / 1024.0 / 1024.0 / 1024.0)}/${node.allocatedMemory.toInt() / 2048.0}GB" }
    ...
    fun serverInfo(server: ClientServer, utilization: Utilization, serverApplication: ApplicationServer): EmbedBuilder {
        return EmbedBuilder().apply {
